                    ...
                    <div class="row push">
                        ...
                        <div class="col-lg-8 col-xl-5">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" value="{{ $candidate->fullname }}" id="one-profile-edit-username" name="candidate-name" placeholder="Enter candidate's full name">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" value="{{ $candidate->matric }}" id="one-profile-edit-name" name="candidate-matric" placeholder="Enter matric number here" >
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="faculty" name="candidate-level">
                                    <option selected value="{{ $candidate->level }}">{{ $candidate->level }}</option>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="faculty" name="candidate-screened">
                                    <option selected value="{{ $candidate->screened }}">{{ $candidate->screened === 1 ? "Yes" : "No" }}</option>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    <img class="img-avatar" src="{{ asset($candidate->image_path ?? 'assets/media/avatars/avatar13.jpg') }}" alt="">
                                </div>
                                <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <input type="submit" class="btn btn-alt-primary" value="Update">
                            </div>
                        </div>
                    </div>
                </form>
